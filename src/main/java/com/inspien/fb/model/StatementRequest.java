...
public class StatementRequest {
     ...
     * "rv_nm":"XXXXX","cpt_rtu_yn":"Y","cpt_rq_dt":"20201223","cpt_rq_no":
     * "FR5829495665"
     * }
     */
    ...
    private String scf_code; // 11.입금,21.출금 31.입금취소,32.출금취소,99.기타,20.입금,21.추심입금,30.지급,31.부도지급
                             // 40.입금이자,41.출금이자,81.입금압축기장 82.출금압축기장,61.기존계좌내역 계좌등록시,62.기존계좌내역 계좌해지시
